...
The user has provided the following text or values contained in the image in question. 
For example, `content_text` is the text extracted from the image (which is accurate and should be considered as truth).
Consider them as truth (overriding any text you might extract from the image), use them and refer to them in your analysis to inform your response:
